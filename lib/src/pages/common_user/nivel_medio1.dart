...
class NivelMedio1Screen extends StatefulWidget {
  const NivelMedio1Screen({super.key});

  @override
  State<NivelMedio1Screen> createState() => _NivelMedio1ScreenState();
}

class _NivelMedio1ScreenState extends State<NivelMedio1Screen> {
