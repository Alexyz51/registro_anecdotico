...
class FirstTimeSetupUserScreen extends StatefulWidget {
  const FirstTimeSetupUserScreen({super.key});

  @override
  State<FirstTimeSetupUserScreen> createState() => _FirstTimeSetupScreenState();
}

class _FirstTimeSetupScreenState extends State<FirstTimeSetupUserScreen> {
  final List<String> cargos = ['Docente', 'Secretario', 'Secretaria'];
