...
class EscolarBasica1Screen extends StatefulWidget {
  const EscolarBasica1Screen({super.key});

  @override
  State<EscolarBasica1Screen> createState() => _EscolarBasica1ScreenState();
}

class _EscolarBasica1ScreenState extends State<EscolarBasica1Screen> {
